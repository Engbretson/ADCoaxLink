...
namespace Internal {
    ...
    class FormatConverterAny {
        ...
        private:
            static ge::IMAGE_ID getConvertedImage(EGenTL &gentl, const std::string &dstFormat, int dstConfig,
            ...
            {
                ge::IMAGE_ID id = getConvertedImage(gentl, dstFormat, dstConfig, imgPtr, fmt, width, height, imgSize, imgPitch);
                uint8_t *dstBuffer = 0;
                size_t dstSize = 0;
                try {
